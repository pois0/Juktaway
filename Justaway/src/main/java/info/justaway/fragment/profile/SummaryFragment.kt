...
class SummaryFragment: Fragment() {
    companion object {
        ...
        private class DestroyBlockTask(fragment: SummaryFragment): info.justaway.task.DestroyBlockTask() {
            val ref = WeakReference(fragment)
        ...
        private class FollowTask(fragment: SummaryFragment): info.justaway.task.FollowTask() {
            val ref = WeakReference(fragment)
